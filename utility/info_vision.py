...
"""
    ...
    Return:
        - tot: int
            secondi totale univoci di visione del corso
"""
...
"""
    ...
    Return:
        - pecentuale: float
            percentuale visione dell'utente di una lezione 
"""
def compute_user_perc_vision_lecture(dm, id_user, id_lecture, id_course):
    ...
    for s in sessions:
        ...
        for e in s[3]:
            ...
            #-- aggiornamento del play e parametri di visione
            if e[0]=="PL":
                play = 1
            elif e[0]=="PS":
                play = 0
...
"""
    Calcolo tempo totale in secondi visione della lezione
    ...
    Return:
        - tot: int
            secondi totale univoci di visione della lezione
"""
